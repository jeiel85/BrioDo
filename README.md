...
| 기능 | 설명 |
|------|------|
| **AI 자연어 입력** | "내일 오후 3시 팀 회의" → 날짜/시간 자동 추출, 제목 정제, 태그 자동 추천 (Gemini 2.5 Flash) |
| **Google 캘린더 연동** | BlendDo 전용 캘린더 자동 생성 및 양방향 동기화, 삭제된 캘린더 자동 복구 |
...
│   └── SettingsModal.jsx          # 설정 모달 (테마, 폰트, 캘린더 권한, 로그인)
│
├── constants/
