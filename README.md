...
[![Tests](https://img.shields.io/badge/tests-129%20total-green?style=flat-square)]
...
- 업적 공유 카드 생성 (Canvas API)

### PWA & 위젯
| 기능 | 설명 |
|------|------|
| **PWA 지원** | Service Worker, 오프라인 캐싱, 데스크톱 설치 |
| **Android 위젯** | 잠금화면 위젯, 퀵 버튼 8종 |
...
BrioDo는 포괄적인 테스트 자동화 인프라를 갖추고 있습니다.
...
| **총합** | **129개** | 3개 브라우저에서 100% 통과 |

### 테스트 범위

- **브라우저**: Chromium, Android Chrome, iOS Safari
- **레이아웃**: 오버플로우 감지, 텍스트 잘림, 요소 오버랩
- **반응형**: 7개 브레이크포인트 (320px ~ 1920px)
- **스크린샷**: 모든 UI 상태 자동 캡처
...
### 테스트 결과
- 스크린샷: `test-results/visual-screenshots/`
- 리포트: `test-results/visual-screenshots/layout-report.json`
