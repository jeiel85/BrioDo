...
Blendo는 AI 자연어 처리, Google 캘린더 양방향 동기화, 잠금화면 위젯을 결합한 Android 할 일 관리 앱입니다.
...
| 기능 | 설명 |
|------|------|
| **전용 캘린더 자동 생성** | "Blendo" 캘린더 자동 생성, 삭제 시 자동 복구 |
...
Blendo는 다음 오픈소스 라이브러리를 사용하며, 모든 라이센스를 준수합니다.
...
*Blendo — Blend your life, Do it smoothly.*
