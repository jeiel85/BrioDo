...
export const ACHIEVEMENT_DEFS = [
  ...
  { id: 'D2', icon: '☀️', difficulty: 5, category: 'daily', name: n('얼리버드','Early Bird','アーリーバード','早鸟'), desc: n('오전 9시 전에 3개 완료','Complete 3 tasks before 9am','午前9時前に3件完了','上午9点前完成3件'), check: s => false },
  { id: 'D3', icon: '🌙', difficulty: 5, category: 'daily', name: n('야행성','Night Owl','夜型','夜猫子'), desc: n('오후 11시 이후에 할 일 완료','Complete a task after 11pm','午後11時以降にタスク完了','晚上11点后完成任务'), check: s => false },
  { id: 'D4', icon: '⚡', difficulty: 4, category: 'daily', name: n('스피드런','Speed Run','スピードラン','速通'), desc: n('당일 등록한 할 일을 1시간 내 완료','Complete a task within 1 hour of adding','追加後1時間以内に完了','添加后1小时内完成'), check: s => false },
  ...
  { id: 'W2', icon: '💼', difficulty: 5, category: 'weekly', name: n('평일 전사','Weekday Warrior','平日ウォリアー','工作日战士'), desc: n('월~금 5일 연속 최소 1개 완료','Complete tasks Mon–Fri 5 days in a row','月〜金5日連続1件完了','周一至周五连续5天完成'), check: s => false },
  { id: 'W3', icon: '🗓️', difficulty: 6, category: 'weekly', name: n('주말 집중','Weekend Warrior','週末集中','周末集中'), desc: n('토·일 각각 3개 이상 완료','Complete 3+ tasks each weekend day','土日それぞれ3件以上完了','周六周日各完成3件以上'), check: s => false },
  { id: 'W4', icon: '🌸', difficulty: 3, category: 'weekly', name: n('월요일 리셋','Monday Reset','月曜リセット','周一重启'), desc: n('월요일에 5개 이상 완료','Complete 5+ tasks on a Monday','月曜日に5件以上完了','周一完成5件以上'), check: s => false },
  { id: 'W5', icon: '📅', difficulty: 8, category: 'weekly', name: n('한달 꽉 채우기','Month Full','月間フル','月度满载'), desc: n('한 달에 100개 이상 완료','100+ completions in a month','1ヶ月に100件以上完了','一个月内完成100件以上'), check: s => false },
  // Recurrence
  ...
  { id: 'R2', icon: '📆', difficulty: 5, category: 'recurrence', name: n('습관의 씨앗','Habit Seed','習慣の種','习惯种子'), desc: n('반복 일정을 7회 연속 완료','Complete a recurring task 7 times','繰り返しタスクを7回連続完了','连续7次完成重复任务'), check: s => false },
  ...
  { id: 'R4', icon: '💎', difficulty: 9, category: 'recurrence', name: n('100번 반복','100 Reps','100回繰り返し','100次重复'), desc: n('반복 일정 누적 100회 완료','100 total recurring completions','繰り返しタスク累計100回完了','累计完成100次重复任务'), check: s => false },
  // Tags
  ...
  // AI
  { id: 'AI1', icon: '🤖', difficulty: 2, category: 'ai', name: n('AI 친구','AI Buddy','AIフレンド','AI朋友'), desc: n('AI 자연어 입력 첫 사용','Use AI input for the first time','AI入力を初めて使用','首次使用AI输入'), check: s => false },
  { id: 'AI2', icon: '🎙️', difficulty: 3, category: 'ai', name: n('말하는 생산성','Voice Power','話す生産性','说话的生产力'), desc: n('음성 입력 첫 사용','Use voice input for the first time','音声入力を初めて使用','首次使用语音输入'), check: s => false },
  { id: 'AI3', icon: '🧠', difficulty: 5, category: 'ai', name: n('AI 파트너','AI Partner','AIパートナー','AI伙伴'), desc: n('AI 입력으로 10개 할 일 생성','Create 10 tasks using AI','AI入力で10件タスク作成','用AI输入创建10件任务'), check: s => false },
  { id: 'AI4', icon: '🗣️', difficulty: 7, category: 'ai', name: n('음성 마스터','Voice Master','音声マスター','语音大师'), desc: n('음성 입력으로 20개 할 일 생성','Create 20 tasks using voice','音声入力で20件タスク作成','用语音输入创建20件任务'), check: s => false },
  // Calendar
  { id: 'CAL1', icon: '📆', difficulty: 2, category: 'calendar', name: n('캘린더 연동','Calendar Sync','カレンダー連携','日历同步'), desc: n('Google Calendar 첫 연동','Sync with Google Calendar','Googleカレンダーと初めて連携','首次与Google日历同步'), check: s => false },
  { id: 'CAL2', icon: '🔗', difficulty: 6, category: 'calendar', name: n('동기화 유지','Sync Maintained','同期維持','保持同步'), desc: n('캘린더 연동으로 7일 이상 사용','Use with calendar sync for 7+ days','カレンダー連携で7日以上使用','保持日历同步使用7天以上'), check: s => false },
  // Notes
  ...
  // Special
  { id: 'SP1', icon: '🎆', difficulty: 4, category: 'special', name: n('새해 결심','New Year Resolution','新年の決意','新年决心'), desc: n('1월 1일에 할 일 완료','Complete a task on January 1st','1月1日にタスクを完了','在1月1日完成任务'), check: s => false },
  { id: 'SP2', icon: '🎄', difficulty: 4, category: 'special', name: n('크리스마스 달성','Christmas Done','クリスマス達成','圣诞节完成'), desc: n('12월 25일에 할 일 완료','Complete a task on December 25th','12月25日にタスクを完了','在12月25日完成任务'), check: s => false },
  { id: 'SP3', icon: '🌸', difficulty: 4, category: 'special', name: n('봄의 시작','Spring Start','春の始まり','春天开始'), desc: n('3월 1일에 할 일 완료','Complete a task on March 1st','3月1日にタスクを完了','在3月1日完成任务'), check: s => false },
  // Engagement
  ...
  { id: 'E2', icon: '🔎', difficulty: 2, category: 'engagement', name: n('탐색자','Explorer','探検者','探索者'), desc: n('검색 기능 첫 사용','Use the search feature first time','検索機能を初めて使用','首次使用搜索功能'), check: s => false },
  { id: 'E3', icon: '📱', difficulty: 4, category: 'engagement', name: n('주간 유저','Weekly User','ウィークリーユーザー','周常用户'), desc: n('7일 연속 앱 실행','Open the app for 7 days in a row','アプリを7日連続起動','连续7天打开应用'), check: s => false },
  { id: 'E4', icon: '🌍', difficulty: 9, category: 'engagement', name: n('한 해의 동반자','Year-Long Partner','1年間のパートナー','全年伙伴'), desc: n('365일 앱 사용','Use the app for 365 days total','アプリを365日使用','累计使用应用365天'), check: s => false },
  { id: 'E5', icon: '⭐', difficulty: 3, category: 'engagement', name: n('컬렉션 탐험가','Collection Explorer','コレクション探検家','收藏探险家'), desc: n('컬렉션 뷰 처음 방문','Visit the collections view','コレクションビューを初めて訪問','首次访问收藏视图'), check: s => false },
