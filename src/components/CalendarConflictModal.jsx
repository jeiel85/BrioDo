    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ margin: '0 0 20px', fontSize: '13px', color: 'var(--text-secondary, #aaa)', lineHeight: 1.5 }}>
          {t?.calendarConflictDesc || `Google 캘린더에 "BrioDo" 이름의 캘린더가 ${calendars.length}개 존재합니다. 어떻게 처리할까요?`}
        </p>
